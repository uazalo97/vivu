...
q_vec = (
    embed_client.embeddings.create(input=["VF 3 kích thước chiều dài"], model="text-embedding-3-small")
    .data[0]
    .embedding
)
...
q_vec2 = (
    embed_client.embeddings.create(input=["chính sách bảo hành pin xe điện"], model="text-embedding-3-small")
    .data[0]
    .embedding
)
